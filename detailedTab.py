...
class DetailedTab:
    def __init__(self, notebook):
        ...
        name_frame = Frame(self.frame)
        name_frame.place(x=800+40, y=20+20)
        #예시용
        name = '(주)아웃오브파크'
        name_label = Label(name_frame, text=name, font=(30))
        ...
        description_label = Label(name_frame, text=description, wraplength=720, justify=LEFT)
